...
素材制作授权不包含账号登录，也不自动发布商品、社媒内容、广告或外部消息。真实登录、上架、发帖、投放或外部发送需要覆盖具体动作的用户明确授权；复用已有授权，不要求用户重复批准。

执行前核对目标账号、最终素材、权限范围及适用的投放预算。只有这些信息缺失或当前动作超出授权时才提出具体问题；同时先完成已授权的素材、QA 与可审阅发布清单。宿主权限或发布能力不足时说明实际阻塞，不把它描述成用户尚未授权，也不声称已完成外部操作。
